      ...
      <div class="cols">
        <div class="col">
          ...
          <table>
            ...
            <tr><td>momentum</td><td>${t.context?.session_momentum ? `${t.context.session_momentum.trade_is === 'offsides' ? '<b>OFFSIDES</b>' : t.context.session_momentum.trade_is === 'with' ? 'with' : t.context.session_momentum.trade_is === 'against_weak' ? 'against (weak)' : '—'} · ${esc(t.context.session_momentum.label)}` : '—'}</td></tr>
