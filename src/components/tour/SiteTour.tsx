 ...
 * first /review/month visit when the user has no tour_status yet, and persists
...
export default function SiteTour() {
  ...
  // Auto-start: once, on the first /review/month visit, if no tour_status yet.
  useEffect(() => {
    if (LOCAL_FEATURES_ENABLED) return
    if (startAttemptedRef.current) return
    if (!pathname || pathname !== '/review/month') return
