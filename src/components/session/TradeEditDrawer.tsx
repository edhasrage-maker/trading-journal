...
export default function TradeEditDrawer({
  trade, date, allTags, defaultSymbol, onSave, onClose, onOpenFullLog,
}: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      <div
        ...
        className="w-full max-w-md h-full bg-gray-950 border-l border-gray-800 shadow-2xl flex flex-col"
      >
        ...
        <div className="px-4 py-3 border-t border-gray-800 shrink-0">
          <button
            ...
            title="Open this trade's full log on the intraday page (screenshot, tags, direction…)"
          >
